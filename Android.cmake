...
function(ensure_debug_keystore)
  if(NOT EXISTS ${DEBUG_KEYSTORE_PATH})
    ...
    execute_process(COMMAND ${Java_KEYTOOL} -genkey -v -dname "CN=debug" -keystore ${DEBUG_KEYSTORE_PASS} -storepass ${DEBUG_KEYSTORE_PASS} -alias ${DEBUG_KEYSTORE_KEY} -keypass ${DEBUG_KEYSTORE_PASS} -keyalg RSA -keysize 2048 -validity 10000)
  endif()
endfunction()
